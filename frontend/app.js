...
App = {
  ...
  loadContract: async () => {
    ...
    App.contract_3 = new web3.eth.Contract(abi_3, address_3);
  },
  ...
  createProposal: async () => {
    ...
    // const createNFT = await App.contract_3.methods.createNFT(mortgage,amount).call();
    await App.contract_3.methods.createNFT(mortgage,amount).call();
    console.log("amount: "+" "+amount + ","+ time +" , "+mortgage+"Im here in create NFT");
    //console.log(createNFT);
    // const idtoNFT =await App.contract_3.methods.idtoNFT(mortgage);
    // console.log("Nft value "+ idtoNFT[0] , " " ,idtoNFT[1] , " ",idtoNFT[2]  );
    await App.contract_3.methods.lockNFT('0','0',10).call();
    console.log("Im here in LOCK NFT");
  },
  ...
  getLoan: async () => {
    ...
    loans.forEach(async (loan) => {
      ...
      console.log(loanAmount);
          ...
          const proposalIDfromLoan =  loan.proposalId;
          proposals.forEach(async (proposal) => {
            if ((proposal.proposalId === proposalIDfromLoan)){
              await App.contract_3.methods.buyFractionalShares(proposal.mortgage,(loan.loanAmount),lender).call();
              console.log("Im here in buy");
            }
          })
